...
// Elements
let progressBar, progressFill, playBtn, volumeBtn, loopBtn, timeDisplay, volSlider, volFill;

function getIcon(name) {
    // Return inline SVG instead of img tags for better compatibility
    let svg = '';
    if (name === 'play') svg = '<svg fill="white" width="20" height="20" viewBox="0 0 21 20" xmlns="http://www.w3.org/2000/svg"><path d="m 17.2778,8.30893 -10.54669,-5.84 c -0.61444,-0.34 -1.34,-0.33 -1.94333,0.02555 C 4.19,2.84671 3.83334,3.46893 3.83334,4.16004 V 15.84 c 0,0.6912 0.35666,1.3134 0.95444,1.6656 0.31,0.1822 0.65111,0.2744 0.99444,0.2744 0.32556,0 0.65112,-0.0833 0.94889,-0.2477 l 10.54559,-5.84 c 0.6177,-0.3411 1.0011,-0.99 1.0011,-1.6911 0,-0.70116 -0.3834,-1.35116 -1,-1.69227 z"/></svg>';
    else if (name === 'pause') svg = '<svg fill="white" width="20" height="20" viewBox="0 0 21 20" xmlns="http://www.w3.org/2000/svg"><path d="M 7.16667,2.5 C 6.70833,2.5 6.33333,2.875 6.33333,3.33333 V 16.6667 C 6.33333,17.125 6.70833,17.5 7.16667,17.5 9.16667,17.5 9.16667,17.5 9.16667,17.5 9.625,17.5 10,17.125 10,16.6667 V 3.33333 C 10,2.875 9.625,2.5 9.16667,2.5 Z M 13.8333,2.5 c -0.4583,0 -0.8333,0.375 -0.8333,0.83333 V 16.6667 C 13,17.125 13.375,17.5 13.8333,17.5 h 2 c 0.4584,0 0.8334,-0.375 0.8334,-0.8333 V 3.33333 C 16.6667,2.875 16.2917,2.5 15.8333,2.5 Z"/></svg>';
    else if (name === 'volume-high') svg = '<svg fill="white" width="20" height="20" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M 416,432 A 16,16 0 0 1 402.61,407.26 C 429.85,365.47 448,323.76 448,256 448,189.5 429.82,147.38 402.51,104.61 a 16.011936,16.011936 0 1 1 27,-17.22 c 30.3,47.5 50.49,94.35 50.49,168.61 0,64.75 -14.66,113.63 -50.6,168.74 A 16,16 0 0 1 416,432 Z M 368,384 A 16,16 0 0 1 354.14,360 C 373.05,327.09 384,299.51 384,256 384,211.83 373.07,184.44 354.18,152.06 a 16,16 0 0 1 27.64,-16.12 C 402.92,172.11 416,204.81 416,256 c 0,50.43 -13.06,83.29 -34.13,120 A 16,16 0 0 1 368,384 Z m -136,32 a 23.88,23.88 0 0 1 -14.2,-4.68 8.27,8.27 0 0 1 -0.66,-0.51 L 125.76,336 H 56 A 24,24 0 0 1 32,312 V 200 a 24,24 0 0 1 24,-24 h 69.75 l 91.37,-74.81 a 8.27,8.27 0 0 1 0.66,-0.51 A 24,24 0 0 1 256,120 v 272 a 24,24 0 0 1 -24,24 z M 320,336 a 16,16 0 0 1 -14.29,-23.19 c 9.49,-18.87 14.3,-38 14.3,-56.81 0,-19.38 -4.66,-37.94 -14.25,-56.73 a 16,16 0 0 1 28.5,-14.54 C 346.19,208.12 352,231.44 352,256 c 0,23.86 -6,47.81 -17.7,71.19 A 16,16 0 0 1 320,336 Z"/></svg>';
    else if (name === 'volume-mute') svg = '<svg fill="white" width="20" height="20" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><path d="M 416,432 A 16,16 0 0 1 402.61,407.26 C 429.85,365.47 448,323.76 448,256 448,189.5 429.82,147.38 402.51,104.61 a 16.011936,16.011936 0 1 1 27,-17.22 c 30.3,47.5 50.49,94.35 50.49,168.61 0,64.75 -14.66,113.63 -50.6,168.74 A 16,16 0 0 1 416,432 Z M 368,384 A 16,16 0 0 1 354.14,360 C 373.05,327.09 384,299.51 384,256 384,211.83 373.07,184.44 354.18,152.06 a 16,16 0 0 1 27.64,-16.12 C 402.92,172.11 416,204.81 416,256 c 0,50.43 -13.06,83.29 -34.13,120 A 16,16 0 0 1 368,384 Z m -136,32 a 23.88,23.88 0 0 1 -14.2,-4.68 8.27,8.27 0 0 1 -0.66,-0.51 L 125.76,336 H 56 A 24,24 0 0 1 32,312 V 200 a 24,24 0 0 1 24,-24 h 69.75 l 91.37,-74.81 a 8.27,8.27 0 0 1 0.66,-0.51 A 24,24 0 0 1 256,120 v 272 a 24,24 0 0 1 -24,24 z M 320,336 a 16,16 0 0 1 -14.29,-23.19 c 9.49,-18.87 14.3,-38 14.3,-56.81 0,-19.38 -4.66,-37.94 -14.25,-56.73 a 16,16 0 0 1 28.5,-14.54 C 346.19,208.12 352,231.44 352,256 c 0,23.86 -6,47.81 -17.7,71.19 A 16,16 0 0 1 320,336 Z"/><line x1="100" y1="100" x2="412" y2="412" stroke="white" stroke-width="32" stroke-linecap="round"/></svg>';
    else if (name === 'loop') svg = '<svg fill="white" width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"/></svg>';
...
function initDOM() {
    ...
    overlayContainer.onmouseleave = () => {
        if (volSlider && !isDraggingVolume) volSlider.classList.remove('visible');
    };
        ...
        if (sliderTrack) {
            const updateVolumeFromMouse = (e) => {
                ...
                if (obj) {
                    ...
                    if (rect.height === 0) return; // Prevent division by zero or jumps if hidden
...
function updatePlayIcon(obj) {
    if (!playBtn) return;
    playBtn.innerHTML = obj && !obj.video.paused ? getIcon('pause') : getIcon('play');
}

function updateProgress(obj) {
    if (!obj || !obj.video) return;
...
function updateVolumeUI(obj) {
    if (!volFill || !obj || !volumeBtn) return;
...
export function showVideoControls(videoObj) {
    ...
    if (loopBtn) loopBtn.classList.toggle('active', videoObj.video.loop);
...
export function updateVideoControlsPosition() {
    if (!currentVideoObject || !overlayContainer) return;
    ...
    let targetTop = screenY + screenH + pad;
